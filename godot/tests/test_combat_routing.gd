...
func test_bullet_damages_enemy():
	...
	assert_eq(health_comp.health, 35.0, "Enemy should have taken 15 damage from the bullet")
...
func test_blast_damages_enemy():
	...
	var health_comp = enemy.get_node("HealthComponent")
	assert_eq(health_comp.health, 25.0, "Enemy should have taken 25 damage from the blast")
